...
export default ({
    ...
    Translate > {
        ({ translate }) => ( <
            Translate id = 'login.v2.connectWithNear.desc'
            data = {
    ...
    LoadingDots / >
    <
    AccountSelector signedInAccountId = { signedInAccountId }
    ...
    /> { accountExists === false && < DepositStreamBanner / > } <
    FormButtonGroup >
    <
    FormButton onClick = { onClickCancel }
    color = 'gray-blue'
    ...
    <
    /FormButton> <
    FormButton onClick = { onClickNext }
