...
import DepositStreamBanner from './DepositStreamBanner';
    ...
    return ( <
        ...
        /div> {
            tab === 'collectibles' ? ( <
                ...
                FungibleTokens currentLanguage = { currentLanguage }
        ...
        /div> {
            linkdropAmount !== '0' && ( <
                LinkDropSuccessModal onClose = { handleCloseLinkdropModal }
                linkdropAmount = { linkdropAmount }
                />
            )
        } {
            createFromImplicitSuccess && ( <
                CreateFromImplicitSuccessModal onClose = { handleSetCreateFromImplicitSuccess }
            ...
            createCustomName && ( <
                CreateCustomNameModal onClose = { handleSetCreateCustomName }
            ...
            zeroBalanceAccountImportMethod && ( <
                ZeroBalanceAccountImportedModal onClose = { handleSetZeroBalanceAccountImportMethod }
