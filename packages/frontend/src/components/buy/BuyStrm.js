...
import { getPayMethods } from '../../config/buyStrmConfig';
...
export function BuyNear({ match, location, history }) {
    ...
    const onrampMethods = [
        ...
        PayMethods.utorg,
        PayMethods.streamPay,
    ].filter((v) => !!v);

    return ( <
        StyledContainer >
        <
        FormButton color = 'link go-back'
        onClick = {
            () => history.goBack()
        } >
        <
        ...
        <
        /FormButton> <
        div className = 'title' > < Translate id = 'buyStrm.title' / > < /div> <
        div className = 'subTitle' > < Translate id = 'buyStrm.subTitle' / > < /div> <
        div className = 'wrapper' >
        <
        FundingCard title = 'buyStrm.nearPurchaseTitle'
        subTitle = 'buyStrm.strmPurchaseSubTitle'
        actions = { onrampMethods }
        /> <
        FundingCard title = 'buyStrm.bridgeTokens'
        subTitle = 'buyStrm.bridgeSubTitle'
        actions = {
            [PayMethods.rainbow]
        }
        /> <
        FundingCard title = 'buyStrm.supportedExchanges'
        subTitle = 'buyStrm.supportedSubTitle'
        link = {
            {
                url: 'https://coinmarketcap.com/currencies/stream-protocol/markets/',
                title: 'buyStrm.coinMarketLink'
            }
        }
        actions = {
            [PayMethods.okex, PayMethods.binance, PayMethods.huobi, PayMethods.kraken]
        }
        /> < /
        div > <
        /StyledContainer>
