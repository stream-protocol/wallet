...
import { BuyNear } from './buy/BuyStrm';
...
class Routing extends Component {
    ...
    componentDidMount = async() => {
        ...
        history.listen(async() => {
            ...
            handleClearUrl();
            if (!WALLET_CREATE_NEW_ACCOUNT_FLOW_URLS.find(
                    (path) =>
    ...
    render() {
            ...
            return ( <
                ...
                GlobalStyle / >
                <
                ConnectedRouter basename = { PATH_PREFIX }
                ...
                GlobalAlert / > {
                    ...
                    WEP_PHASE_ONE && ( <
                        WalletMigration open = { this.state.openTransferPopup }
                        history = { this.props.history }
                        ...
                        TwoFactorVerifyModal onClose = {
                            (verified, error) => {
                                ...
                                if (error) {
                                    // tracking error
                                    Mixpanel.track(
                                        '2FA Modal Verify fail', { error: error.message }
                                    );
                                }
                                if (verified) {
                                    Mixpanel.track(
                ...
                /> <
                GuestLandingRoute exact path = "/"
                render = {
                    (props) => ( <
                        WalletWrapper tab = { tab }
                        setTab = { setTab } {...props }
                        />
                    )
                }
                ...
                /> <
                Route exact path = "/linkdrop/:fundingContract/:fundingKey"
                component = { LinkdropLandingWithRouter }
                /> <
                Route exact path = "/create/:fundingContract/:fundingKey"
                ...
                component = { CreateAccountWithRouter }
                /> <
                Route exact path = { '/create-from/:fundingAccountId' }
                component = { CreateAccountWithRouter }
                /> <
                Route exact path = "/set-recovery/:accountId/:fundingContract?/:fundingKey?"
                component = { SetupRecoveryMethodWithRouter }
                /> <
                PublicRoute exact path = "/set-recovery-implicit-account"
                component = {
                    SetupRecoveryImplicitAccountWrapper
                }
                /> <
                PublicRoute exact path = "/setup-passphrase-new-account"
                component = { SetupPassphraseNewAccountWrapper }
                /> <
                PublicRoute exact path = "/setup-ledger-new-account"
                component = { SetupLedgerNewAccountWrapper }
                /> <
                PublicRoute exact path = "/create-implicit-account"
                component = { CreateImplicitAccountWrapper }
                /> <
                Route exact path = "/setup-seed-phrase/:accountId/:step"
                component = { SetupSeedPhraseWithRouter }
                /> <
                Route exact path = "/verify-account"
                component = { VerifyAccountWrapper }
                /> <
                Route exact path = "/initial-deposit"
                component = { InitialDepositWrapper }
                /> <
                Route exact path = "/fund-with-existing-account"
                component = { ExistingAccountWrapper }
                /> <
                Route exact path = "/fund-create-account/:accountId/:implicitAccountId/:recoveryMethod"
                component = { SetupImplicitWithRouter }
                /> <
                Route exact path = "/setup-ledger/:accountId"
                component = { SetupLedgerWithRouter }
                /> <
                PrivateRoute exact path = "/setup-ledger-success"
                component = { SetupLedgerSuccessWithRouter }
                /> <
                PrivateRoute exact path = "/enable-two-factor"
                ...
                /> <
                Route exact path = "/recover-seed-phrase/:accountId?/:seedPhrase?"
                component = { RecoverAccountSeedPhraseWithRouter }
                /> <
                Route exact path = "/recover-with-link/:accountId/:seedPhrase"
                component = { ImportAccountWithLinkWrapper }
                /> <
                Route exact path = "/auto-import-seed-phrase"
                render = {
                    ({ location }) => {
                        ...
                        return ( <
                            AutoImportWrapper secretKey = { secretKey }
                            accountId = {
                                hasAccountId ?
                ...
                /> <
                Route exact path = "/auto-import-secret-key"
                render = {
                    ({ location }) => {
                        const importString = decodeURIComponent(
                            location.hash.substring(1)
                ...
                /> <
                Route exact path = "/batch-import"
                render = {
                    () =>
                    ( < BatchImportAccounts onCancel = {
                            () => this.props.history.replace('/') }
                        />)} /
                        >
                        <
                        Route exact path = "/batch-ledger-export"
                        component = { BatchLedgerExport }
                        /> <
                        Route exact path = "/sign-in-ledger"
                        component = { SignInLedgerWrapper }
                        /> <
                        PrivateRoute path = "/login"
                        component = { LoginWrapper }
                        /> <
                        PrivateRoute exact path = "/authorized-apps"
                        render = {
                            () => ( <
                        ...
                        /> <
                        PrivateRoute exact path = "/full-access-keys"
                        render = {
                            () => ( <
                        ...
                        /> <
                        PrivateRoute exact path = "/send-money/:accountId?"
                        component = { SendContainerWrapper }
                        /> <
                        PrivateRoute exact path = "/nft-detail/:contractId/:tokenId"
                        component = { NFTDetailWrapper }
                        /> <
                        PrivateRoute exact path = "/receive-money"
                        ...
                        component = { Profile }
                        /> <
                        PrivateRoute exact path = "/profile/:accountId?"
                        component = { Profile }
                        /> <
                        PrivateRoute exact path = "/sign"
                        ...
                        Route exact path = "/cli-login-success"
                        ...
                        /> {
                            WEB3AUTH && ( <
                                PrivateRoute exact path = "/verify-owner"
