...
Make sure that account recovery works well on https://wallet.streamprotocol.app.

${accountId ? `Test account to check https://explorer.streamprotocol.app/accounts/${accountId}` : ''}
